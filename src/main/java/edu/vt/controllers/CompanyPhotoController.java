...
@Named("companyPhotoController")
@SessionScoped
public class CompanyPhotoController implements Serializable {
    /*
    ===============================
    ...
    CompanyPhotoFacade bean into the instance variable 'companyPhotoFacade' after it is instantiated at runtime.
     */
    @EJB
    ...
    *********************
    ...
    public String capturedPhoto() {
        return Constants.COMPANY_PHOTOS_URI + filename;
    }

    /*
    *************************
    Handle CompanyUser Photo Capture
    *************************
     */
    public void onCapture(CaptureEvent captureEvent) {

        // Obtain the object reference of the signed-in CompanyUser object
        ...
        String absolutePathOfFilename = Constants.COMPANY_PHOTOS_ABSOLUTE_PATH + filename;
        ...
        CompanyPhoto newPhoto = new CompanyPhoto("png", signedInUser);

        // Create a record for the new Photo object in the database
        companyPhotoFacade.create(newPhoto);

        // Obtain the object reference of the first and only Photo object of the
        // user whose primary key is signedInUser.getId()
        CompanyPhoto photo = companyPhotoFacade.findPhotosByUserPrimaryKey(signedInUser.getId()).get(0);
    ...
    public String redo() {
        filename = "";
        return "/CompanyAccount/ChangePhoto?faces-redirect=true";
    }

    /*
    ************************
    Handle CompanyUser Photo Upload
    ************************
     */
    ...
    /*
    *******************************************************
    Store Uploaded CompanyUser's Photo File and its Thumbnail File
    *******************************************************
     */
    public void storePhotoFile(UploadedFile file) {
        ...
        try {
            ...
            CompanyPhoto newPhoto = new CompanyPhoto(fileExtension, signedInUser);
            ...
            Methods.showMessage("Information", "Success!",
                    "CompanyUser's Photo File is Successfully Uploaded!");
    ...
    ***************************************************
    ...
    private File inputStreamToFile(InputStream inputStream, String targetFilename) throws IOException {
        ...
        try {
            ...
            // Create a new empty file with the given name targetFilename in the CompanyPhotoStorage directory
            targetFile = new File(Constants.COMPANY_PHOTOS_ABSOLUTE_PATH, targetFilename);
            ...
            // Create the targetFile in the CompanyPhotoStorage directory with the inputStream given
    ...
    /*
    ********************************************
    Store Signed-In CompanyUser's Thumbnail Photo Image
    ********************************************
     ...
     */
    private void saveThumbnail(File inputFile, CompanyPhoto inputPhoto) {
        ...
        try {
            ...
            // Create the thumbnail photo file in the CompanyPhotoStorage directory
            File thumbnailPhotoFile = new File(Constants.COMPANY_PHOTOS_ABSOLUTE_PATH, inputPhoto.getThumbnailFileName());
    ...
    /*
    *******************************************************
    Delete Signed-In CompanyUser's Photo and Thumbnail Image Files
    *******************************************************
     */
    public void deletePhoto() {
        ...
        if (!photoList.isEmpty()) {
            ...
            CompanyPhoto photo = photoList.get(0);
            ...
            try {
                ...
                NOTE: Files and Paths are imported as
                 ...
                 getFilePath() is given in CompanyPhoto.java file.
                 */
                Files.deleteIfExists(Paths.get(photo.getPhotoFilePath()));

                /*
                 Delete the user's thumbnail image if it exists.
                 getThumbnailFilePath() is given in CompanyPhoto.java file.
                 */
                Files.deleteIfExists(Paths.get(photo.getThumbnailFilePath()));

                // Delete the photo file record from the database.
                // CompanyPhotoFacade inherits the remove() method from AbstractFacade.
                companyPhotoFacade.remove(photo);
