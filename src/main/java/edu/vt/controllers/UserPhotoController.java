...
public class UserPhotoController implements Serializable {
    ...
    *********************
    ...
    public String capturedPhoto() {
        return Constants.USER_PHOTOS_URI + filename;
    }

    /*
    *************************
    Handle CandidateUser Photo Capture
    *************************
     */
    public void onCapture(CaptureEvent captureEvent) {

        // Obtain the object reference of the signed-in CandidateUser object
        ...
        String absolutePathOfFilename = Constants.USER_PHOTOS_ABSOLUTE_PATH + filename;
    ...
    /*
    ************************
    Handle CandidateUser Photo Upload
    ************************
     */
    ...
    /*
    *******************************************************
    Store Uploaded CandidateUser's Photo File and its Thumbnail File
    *******************************************************
     */
    public void storePhotoFile(UploadedFile file) {
        ...
        try {
            ...
            Methods.showMessage("Information", "Success!",
                    "CandidateUser's Photo File is Successfully Uploaded!");
    ...
    ***************************************************
    ...
    /*
    ********************************************
    Store Signed-In CandidateUser's Thumbnail Photo Image
    ********************************************
    ...
    /*
    *******************************************************
    Delete Signed-In CandidateUser's Photo and Thumbnail Image Files
    *******************************************************
     */
