...
public class CandidateLoginManager implements Serializable {
    ...
    public String loginUser() {
        ...
        if (user == null) {
            ...
            if (user.isTwoFactorEnabled()) {
                ...
                setupTwoFactor(user);
                return "/CandidateAccount/TwoFactor?faces-redirect=true";
    ...
    ******************************************************************
    ...
    private void setupTwoFactor(CandidateUser user) {
        this.user = user;
        ...
        String subject = "Two-Factor Authentication Code for " + user.getFirstName();
